...
def import_diagram(whiteboard_id: str, code: str, style: str = "classic") -> str:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--code", required=True, help="PlantUML 代码")
    parser.add_argument("--style", default="classic", choices=["classic", "board"], help="渲染样式")
    args = parser.parse_args()
    try:
        print(import_diagram(args.whiteboard_id, args.code, args.style))
